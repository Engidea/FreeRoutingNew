...
public class DsnKeywordPackage
   ...
   public static void write_scope(DsnWriteScopeParameter p_par, freert.library.LibPackage p_package) throws java.io.IOException
      ...
      for ( PlaShape a_shape : p_package.outline_shapes )
         {
         p_par.file.start_scope();
         p_par.file.write("outline");
         DsnShape curr_outline = p_par.coordinate_transform.board_to_dsn_rel(a_shape, DsnLayer.SIGNAL);
   ...
   private static void write_package_keepout(freert.spectra.varie.DsnPackageKeepout p_keepout, DsnWriteScopeParameter p_par, boolean p_is_via_keepout) throws java.io.IOException
      {
