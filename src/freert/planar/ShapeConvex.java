...
public interface ShapeConvex extends PlaShape
    ...
    * If p_distance > 0, the shape will be enlarged, else the result shape will be smaller
    */
   ShapeConvex offset(double p_distance);

   /**
    * Shrinks the shape by p_offset. The result shape will not be empty.
    * Is this just like offset ?
    */
   ShapeConvex shrink(double p_offset);
