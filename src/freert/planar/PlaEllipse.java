...
/**
 * Describes functionality of an elllipse in the plane. Does not implement the ConvexShape interface, because coordinates are float.
 *
 * @author Alfons Wirtz
 */
public final class PlaEllipse implements java.io.Serializable
   {
   ...
   public PlaEllipse(PlaPointFloat p_center, double p_rotation, double p_radius_1, double p_radius_2)
      {
      center = p_center;
      double curr_rotation;
      if (p_radius_1 >= p_radius_2)
         {
         bigger_radius = p_radius_1;
         smaller_radius = p_radius_2;
         curr_rotation = p_rotation;
         }
      else
         {
         bigger_radius = p_radius_2;
