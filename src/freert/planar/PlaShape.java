...
public interface PlaShape extends PlaArea
   {
   ...
   /**
    * Returns the smallest distance from the center of gravity to the border of the shape.
    */
    ...
    */
   boolean intersects(PlaShape p_other);
    ...
    */
   boolean intersects(ShapeTileBox p_other);
    ...
    * Auxiliary function to implement the same function with parameter type Shape.
    */
   boolean intersects(ShapeTileSimplex p_other);
