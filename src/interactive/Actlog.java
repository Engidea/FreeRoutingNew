...
/**
 * Log to track the actions in the interactive board handling for automatic replay.
 * @author Alfons Wirtz
 */
...
public class Actlog
    ...
    */
   public PlaPointFloat read_corner()
      {
   ...
   /**
    * Marks the beginning of a new scope in the output stream Writes also 1, if p_boolean_value is true, or 0, if p_boolean_value
    * is false;
    */
    ...
    */
   public void start_scope(LogfileScope p_logfile_scope, PlaPointFloat p_start_corner)
      {
      start_scope(p_logfile_scope);
   ...
   public void add ( boolean a_value )
      {
      add_int ( a_value ? 1 : 0);
      }
