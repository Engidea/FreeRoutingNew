...
public abstract class AlgoPullTight
    ...
    */
   public static AlgoPullTight get_instance(RoutingBoard p_board, NetNosList p_only_net_no_arr, 
         int p_min_move_dist, ThreadStoppable p_stoppable, BrdKeepPoint p_keep_point)
      {
    ...
    */
   protected AlgoPullTight(RoutingBoard p_board, NetNosList p_only_net_no_arr, 
         ThreadStoppable p_stoppable_thread, BrdKeepPoint p_keep_point, int p_min_move_dist)
      {
      r_board = p_board;
   ...
   public final boolean split_traces_keep_point()
      ...
      for (BrdItem curr_item : picked_items)
         ...
         ArrayList<BrdTracep> clean_list = a_trace.split_with_end_point(line_idx, keep_point.keep_point, 0.01);
