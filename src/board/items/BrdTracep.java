...
//      if ( other_split && own_split == false ) System.err.println("other_split && own_split == false");
   ...
   public boolean pull_tight(AlgoPullTight p_pull_tight_algo)
      ...
      if ( r_board.brd_rules.get_pin_edge_to_turn_dist() > 0)
         {
   ...
   public boolean swap_connection_to_pin(boolean p_at_start)
      ...
      if (!check_swap)
         ...
         if (trace_polyline.plaline_len() > 3 && trace_polyline.corner_approx(0).distance_square(trace_polyline.corner_approx(1)) <= half_width * half_width)
            {
