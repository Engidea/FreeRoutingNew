...
public abstract class ArtConnectionLocate
    ...
    */
   public static ArtConnectionLocate get_instance(MazeSearchResult p_maze_search, ArtControl p_ctrl, AwtreeShapeSearch p_search_tree, TraceAngleRestriction p_angle_restriction, SortedSet<BrdItem> p_ripped_list )
      {
   ...
   protected ArtConnectionLocate(MazeSearchResult p_maze_search_result, ArtControl p_ctrl, AwtreeShapeSearch p_search_tree, TraceAngleRestriction p_angle_restriction, SortedSet<BrdItem> p_ripped_list )
      {
      art_ctrl = p_ctrl;
    ...
    */
   private PlaPointFloat calculate_starting_point(ExpandDoorItem p_from_door, AwtreeShapeSearch p_search_tree)
      {
