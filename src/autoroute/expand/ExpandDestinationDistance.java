 ...
 * a new MazeExpansionElement and the destination set of the expansion.
 *
 * @author Alfons Wirtz
 */
public final class ExpandDestinationDistance
   {
   private final ExpandCostFactor[] trace_costs;
   ...
   // minimum of min_component_side_trace_cost and max_inner_side_trace_cost
   ...
   // minimum of min_component_inner_trace_cost and min_solder_inner_trace_cost
   private ShapeTileBox component_side_box = ShapeTileBox.EMPTY;
   private ShapeTileBox solder_side_box = ShapeTileBox.EMPTY;
   private ShapeTileBox inner_side_box = ShapeTileBox.EMPTY;
    ...
    */
   public ExpandDestinationDistance(ExpandCostFactor[] p_trace_costs, boolean[] p_layer_active, double p_min_normal_via_cost, double p_min_cheap_via_cost)
      {
      ...
      for (int ind = 0; ind < layer_count; ++ind)
         {
         if (layer_active[ind]) curr_active_layer_count++;
         }
      
      active_layer_count = curr_active_layer_count;
      ...
      if (layer_active[layer_count - 1])
         {
         ExpandCostFactor curr_trace_cost = trace_costs[layer_count - 1];
   ...
   public void join(ShapeTileBox p_box, int p_layer)
      {
      if (p_layer == 0)
         {
   ...
   public double calculate(PlaPointFloat p_point, int p_layer)
      {
   ...
   public double calculate(ShapeTileBox p_box, int p_layer)
      ...
      if (p_box.box_ll.v_x > component_side_box.box_ur.v_x)
         {
         component_side_delta_x = p_box.box_ll.v_x - component_side_box.box_ur.v_x;
         }
      else if (p_box.box_ur.v_x < component_side_box.box_ll.v_x)
         {
         component_side_delta_x = component_side_box.box_ll.v_x - p_box.box_ur.v_x;
         }
      else
         {
      ...
      if (p_box.box_ll.v_y > component_side_box.box_ur.v_y)
         {
         component_side_delta_y = p_box.box_ll.v_y - component_side_box.box_ur.v_y;
         }
      else if (p_box.box_ur.v_y < component_side_box.box_ll.v_y)
         {
         component_side_delta_y = component_side_box.box_ll.v_y - p_box.box_ur.v_y;
         }
      else
         {
      ...
      if (p_box.box_ll.v_x > solder_side_box.box_ur.v_x)
         {
         solder_side_delta_x = p_box.box_ll.v_x - solder_side_box.box_ur.v_x;
         }
      else if (p_box.box_ur.v_x < solder_side_box.box_ll.v_x)
         {
         solder_side_delta_x = solder_side_box.box_ll.v_x - p_box.box_ur.v_x;
         }
      else
         {
      ...
      if (p_box.box_ll.v_y > solder_side_box.box_ur.v_y)
         {
         solder_side_delta_y = p_box.box_ll.v_y - solder_side_box.box_ur.v_y;
         }
      else if (p_box.box_ur.v_y < solder_side_box.box_ll.v_y)
         {
         solder_side_delta_y = solder_side_box.box_ll.v_y - p_box.box_ur.v_y;
         }
      else
         {
      ...
      if (p_box.box_ll.v_x > inner_side_box.box_ur.v_x)
         {
         inner_side_delta_x = p_box.box_ll.v_x - inner_side_box.box_ur.v_x;
         }
      else if (p_box.box_ur.v_x < inner_side_box.box_ll.v_x)
         {
         inner_side_delta_x = inner_side_box.box_ll.v_x - p_box.box_ur.v_x;
         }
      else
         {
      ...
      if (p_box.box_ll.v_y > inner_side_box.box_ur.v_y)
         {
         inner_side_delta_y = p_box.box_ll.v_y - inner_side_box.box_ur.v_y;
         }
      else if (p_box.box_ur.v_y < inner_side_box.box_ll.v_y)
         {
         inner_side_delta_y = inner_side_box.box_ll.v_y - p_box.box_ur.v_y;
         }
      else
         {
   ...
   public double calculate_cheap_distance(ShapeTileBox p_box, int p_layer)
      {
