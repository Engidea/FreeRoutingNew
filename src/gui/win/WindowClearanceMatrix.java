...
public final class WindowClearanceMatrix extends GuiSubWindowSavable
   ...
   public void refresh()
      ...
      if (this.clearance_table_model.getRowCount() != routing_board.brd_rules.clearance_matrix.get_class_count())
         {
   ...
   private javax.swing.JPanel add_clearance_table(BoardFrame p_board_frame)
      ...
      javax.swing.JScrollPane scroll_pane = new javax.swing.JScrollPane(scroll_panel, javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
      ...
      if (p_board_frame.get_locale().getLanguage().equalsIgnoreCase("de"))
         {
         javax.swing.JLabel bug_label = new javax.swing.JLabel("Wegen eines Java-System-Bugs muss das Dezimalkomma in dieser Tabelle als Punkt eingegeben werden!");
   ...
   private void add_class()
      ...
      final RoutingBoard routing_board = this.board_frame.board_panel.board_handling.get_routing_board();
      ...
      for (int i = clearance_matrix.get_class_count() - 1; i >= 2; --i)
         ...
         for (int j = clearance_matrix.get_class_count() - 1; j >= 0; --j)
            ...
            if (clearance_matrix.is_equal(i, j))
               ...
               int selected_option = JOptionPane.showConfirmDialog(getJFrame(), message, null, javax.swing.JOptionPane.YES_NO_OPTION);
   ...
   private class ClearanceTableModel extends javax.swing.table.AbstractTableModel implements java.io.Serializable
      ...
      public void setValueAt(Object p_value, int p_row, int p_col)
         ...
         ClearanceMatrix clearance_matrix = board_handling.get_routing_board().brd_rules.clearance_matrix;
         ...
         if (items_already_assigned)
            ...
            int selected_option = javax.swing.JOptionPane.showConfirmDialog(getJFrame(), message, null, javax.swing.JOptionPane.YES_NO_OPTION);
            ...
            for (int j = 0; j < clearance_matrix.get_class_count(); ++j)
               ...
               if (p_layer == ComboBoxLayer.ALL_LAYER_INDEX)
                  ...
                  if (clearance_matrix.is_layer_dependent(i, j))
                     ...
                     {
                     Float curr_table_value = (float) board_handling.coordinate_transform.board_to_user(clearance_matrix.value_at(i, j, 0));
                  ...
                  if (clearance_matrix.is_inner_layer_dependent(i, j))
                     ...
                     {
                     Float curr_table_value = (float) board_handling.coordinate_transform.board_to_user(clearance_matrix.value_at(i, j, 1));
                     this.data[i][j + 1] = curr_table_value;
                     }
                  }
               else
                  {
                  Float curr_table_value = (float) board_handling.coordinate_transform.board_to_user(clearance_matrix.value_at(i, j, p_layer));
                  this.data[i][j + 1] = curr_table_value;
                  }
               }
            }
