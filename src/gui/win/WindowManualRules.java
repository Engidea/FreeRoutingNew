 ...
 * @author Alfons Wirtz
 */
public class WindowManualRules extends GuiSubWindowSavable
   {
   ...
   public WindowManualRules(BoardFrame p_board_frame)
      ...
      this.via_rule_combo_box = new JComboBox<RuleViaInfoList>(routing_board.brd_rules.via_rules);
      ...
      this.clearance_combo_box = new ComboBoxClearance(routing_board.brd_rules.clearance_matrix);
      gridbag_constraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
      ...
      int curr_half_width = this.board_handling.itera_settings.get_manual_trace_half_width(0);
      ...
      this.layer_combo_box = new ComboBoxLayer(this.board_handling.get_routing_board().layer_structure, p_board_frame.get_locale());
      gridbag_constraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
   ...
   public void refresh()
      ...
      this.clearance_combo_box.setSelectedIndex(board_handling.itera_settings.get_manual_trace_clearance_class());
      int via_rule_index = board_handling.itera_settings.get_manual_via_rule_index();
      if (via_rule_index < this.via_rule_combo_box.getItemCount())
         {
         this.via_rule_combo_box.setSelectedIndex(board_handling.itera_settings.get_manual_via_rule_index());
         }
    ...
    */
   private void set_selected_layer(GuiLayer p_layer)
      {
      int curr_half_width;
      if (p_layer.index == ComboBoxLayer.ALL_LAYER_INDEX)
         ...
         int first_half_width = this.board_handling.itera_settings.get_manual_trace_half_width(0);
         for (int i = 1; i < this.board_handling.get_layer_count(); ++i)
            {
            if (this.board_handling.itera_settings.get_manual_trace_half_width(i) != first_half_width)
               {
         ...
         boolean trace_widths_layer_dependent = false;
         int first_half_width = this.board_handling.itera_settings.get_manual_trace_half_width(1);
         ...
         {
         curr_half_width = this.board_handling.itera_settings.get_manual_trace_half_width(p_layer.index);
         }
   ...
   private final JComboBox<RuleViaInfoList> via_rule_combo_box;
   ...
   private class LayerComboBoxListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent evt)
         {
         GuiLayer new_selected_layer = layer_combo_box.get_selected_layer();
   ...
   private class ClearanceComboBoxListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent evt)
         ...
         board_handling.itera_settings.set_manual_trace_clearance_class(new_index);
         }
      }
   ...
   private class ViaRuleComboBoxListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent evt)
         ...
         board_handling.itera_settings.set_manual_via_rule_index(new_index);
         }
      }
