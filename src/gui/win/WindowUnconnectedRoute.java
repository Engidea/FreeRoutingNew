...
public class WindowUnconnectedRoute extends WindowObjectListWithFilter
   ...
   protected void fill_list()
      ...
      for (BrdItem curr_item : board_items)
         {
         if (!(curr_item instanceof BrdTrace || curr_item instanceof BrdAbitVia))
            {
         ...
         for (BrdItem curr_connnected_item : curr_connected_set)
            ...
            if (!(curr_connnected_item instanceof board.items.BrdTrace || curr_connnected_item instanceof board.items.BrdAbitVia))
               {
