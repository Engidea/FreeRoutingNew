 ...
 * @author Alfons Wirtz
 */
public class WindowDisplayMisc extends GuiSubWindowSavable
   {
   ...
   public WindowDisplayMisc(BoardFrame p_board_frame)
      ...
      GuiResources resources = board_frame.newGuiResources("gui.resources.DisplayMisc");
   ...
   public void refresh()
      {
      small_cursor_checkbox.setSelected( ! panel.is_cross_hair_cursor());
   ...
   private class SmallCursorListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         panel.set_crosshair_cursor(false);
         }
      }
   ...
   private class BigCursorListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         panel.set_crosshair_cursor(true);
         }
      }
   ...
   private class HorizontalMirrorListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         ...
         // remember the old viewort center to retain the displayed section of the board.
         PlaPointFloat old_viewport_center = coordinate_transform.screen_to_board(panel.get_viewport_center());
