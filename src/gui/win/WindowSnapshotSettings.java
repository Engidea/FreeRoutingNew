 ...
 * @author Alfons Wirtz
 */
public class WindowSnapshotSettings extends GuiSubWindowSavable
   {
   ...
   private class ObjectColorListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().object_colors = object_color_check_box.isSelected();
         }
      }
   ...
   private class ObjectVisibilityListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().object_visibility = object_visibility_check_box.isSelected();
         }
      }
   ...
   private class LayerVisibilityListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().layer_visibility = layer_visibility_check_box.isSelected();
         }
      }
   ...
   private class DisplayRegionListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().display_region = display_region_check_box.isSelected();
         }
      }
   ...
   private class InteractiveStateListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().interactive_state = interactive_state_check_box.isSelected();
         }
      }
   ...
   private class SelectionLayersListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().selection_layers = selection_layers_check_box.isSelected();
         }
      }
   ...
   private class SelectableItemsListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().selectable_items = selectable_items_check_box.isSelected();
         }
      }
   ...
   private class CurrentLayerListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().current_layer = current_layer_check_box.isSelected();
         }
      }
   ...
   private class RuleSelectionListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().rule_selection = rule_selection_check_box.isSelected();
         }
      }
   ...
   private class ManualRuleSettingsListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().manual_rule_settings = manual_rule_settings_check_box.isSelected();
         }
      }
   ...
   private class PushAndShoveEnabledListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().push_and_shove_enabled = push_and_shove_enabled_check_box.isSelected();
         }
      }
   ...
   private class DragComponentsEnabledListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().drag_components_enabled = drag_components_enabled_check_box.isSelected();
         }
      }
   ...
   private class PullTightRegionListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().pull_tight_region = pull_tight_region_check_box.isSelected();
         }
      }
   ...
   private class ComponentGridListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().component_grid = component_grid_check_box.isSelected();
         }
      }
   ...
   private class InfoListFilterListener implements java.awt.event.ActionListener
      ...
      public void actionPerformed(java.awt.event.ActionEvent p_evt)
         {
         board_handling.itera_settings.get_snapshot_attributes().info_list_selections = info_list_filter_check_box.isSelected();
         }
      }
   }
