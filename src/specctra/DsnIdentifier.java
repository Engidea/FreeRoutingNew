 ...
 * This is used while writing Dsn or other files that need possibly quoted identifiers
 * @author alfons
 */
public class DsnIdentifier
   {
   /**
    * Defines the reserved characters and the string for quoting identifiers containing reserved characters for a new instance of
    * Identifier.
    */
   public DsnIdentifier(String[] p_reserved_chars, String p_string_quote)
      {
