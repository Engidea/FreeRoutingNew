...
public class LibPackagePin implements java.io.Serializable
   ...
   public final PlaVector relative_location;
    ...
    */
   public LibPackagePin(String p_name, int p_padstack_no, PlaVector p_relative_location, double p_rotation_in_degree)
      {
      name = p_name;
